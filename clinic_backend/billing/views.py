        ...
        try:
            ...
            allocations = appointment.patient.bed_allocations.filter(
                ...
                status__in=[
                    "ACTIVE",
                    "DISCHARGED",
                ],  # Must be explicitly Active or Discharged
        ...
        prior_visits_count = (
            ...
            .filter(
                ...
                | Q(
                    ...
                    appointment_time__lt=appointment.appointment_time,
                )
            )
            .count()
        )
        ...
        response_data = {
            ...
            "doctor": {
                ...
                "department": (
                    ...
                    if invoice.appointment.doctor.department
                    else "General"
                ),
            },
            "appointment": {
        ...
        try:
            with transaction.atomic():
                ...
                target_amount = (
                    ...
                    if billing.final_amount > 0
                    else billing.total_amount
                )
